...
TOKEN_REFRESH_INTERVAL = config.get('TOKEN_REFRESH_INTERVAL', 2700)  # 45分钟
TOKEN_RETRY_INTERVAL = config.get('TOKEN_RETRY_INTERVAL', 300)  # 5分钟
TOKEN_REFRESH_BUFFER = config.get('TOKEN_REFRESH_BUFFER', 900)  # 提前15分钟刷新
PENDING_CONFIRM_RETRY_INTERVAL = config.get('PENDING_CONFIRM_RETRY_INTERVAL', 300)  # 待确认队列5分钟重试
PENDING_CONFIRM_MAX_AGE = config.get('PENDING_CONFIRM_MAX_AGE', 1800)  # 待确认订单最大保留30分钟
